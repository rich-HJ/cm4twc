    ...
    for (k=0; k < nx; k++)
      {
        ...
        transfer_k[jk] = (driving_a[jk] * parameter_a) + transfer_n[jk]
          + state_a_0[jk];
        transfer_m[jk] = (driving_a[jk] * parameter_a) + transfer_i[jk]
          + state_b_0[jk];
        // compute outputs
        output_x[jk] = (driving_a[jk] * parameter_a) + transfer_n[jk]
          - state_a_0[jk];
      }
}
